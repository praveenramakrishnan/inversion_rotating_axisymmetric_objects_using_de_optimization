//Implementtion of differential evolution algorithm for optimization
...
namespace de
{
	...
	std::vector<double> beta_limits;
	std::vector<double> measured_data;
    };
...
public:
	double m_get_minCost() const
	{
		return m_minCost;
	}

	const std::vector<double>& m_get_bestAgent() const
	{
		return m_population[m_bestAgentIndex];
	}
    };
